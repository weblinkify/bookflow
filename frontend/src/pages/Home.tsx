    ...
    <div className="min-h-[93dvh] bg-gradient-to-br from-blue-50 via-white to-indigo-50 flex items-center justify-center p-4">
      ...
      <div className="w-full max-w-md relative z-10 bg-white rounded-2xl shadow-2xl overflow-hidden text-center">
        ...
        <div className="px-8 py-8 space-y-6">
          ...
          <Link to="/book">
            <button className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-bold py-3 rounded-lg shadow-lg transition">
              Book Appointment
            </button>
          </Link>
