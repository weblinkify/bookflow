...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br bg-gray-950 pt-20 pb-20 px-4 flex items-center justify-center ">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-blue-800 px-8 py-8">
            ...
            <p className="text-blue-100 text-center mt-2">Sign in to your BookFlow account</p>
          </div>
